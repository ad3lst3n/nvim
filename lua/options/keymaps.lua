...
-- TogglTerm
-- vim.keymap.set("n", "<A-Space>", function() vim.cmd("FloatermToggle") end, { desc = "Toggle Term"})
-- vim.keymap.set("t", "<A-Space>", function() vim.cmd("FloatermToggle") end, { desc = "Toggle Term"})
